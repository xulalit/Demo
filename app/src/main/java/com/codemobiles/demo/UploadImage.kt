...
class UploadImage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        SelectImage.setOnClickListener(View.OnClickListener {
            CropImage.activity().start(this@UploadImage)
            //fromRemoteModel()
        })
    }
    private fun setLabelerFromLocalModel(uri: Uri) {
        ...
        try {
            ...
            image = FirebaseVisionImage.fromFilePath(this@UploadImage, uri)
            ...
            .addOnCompleteListener { task ->
                if (task.isComplete) {
                    ...
                    try {
                        ...
                        Toast.makeText(this@UploadImage, "Ml exeception", Toast.LENGTH_SHORT)
                            .show()
                ...
                Toast.makeText(this@UploadImage, "err$e", Toast.LENGTH_SHORT).show()
            }
    }
    ...
    private fun processImageLabeler(
        ...
        labeler.processImage(image).addOnCompleteListener { task ->
            ...
            Log.e("OnFail", "" + e)
            Toast.makeText(this@UploadImage, "Something went wrong! $e", Toast.LENGTH_SHORT)
                .show()
        }
    }
    ...
    private fun fromRemoteModel() {
        ...
        FirebaseModelManager.getInstance().download(remoteModel!!, conditions!!)
            .addOnCompleteListener {
                CropImage.activity().start(this@UploadImage) // open image crop activity
            }
    }
}
